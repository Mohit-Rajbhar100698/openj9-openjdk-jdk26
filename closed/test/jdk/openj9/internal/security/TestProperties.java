...
public class TestProperties {
    ...
    private static Stream<Arguments> patternMatches_strongAlgorithms_expectedExitValue1() {
        ...
        if (isProviderPresent("OpenJCEPlusFIPS")) {
            ...
            // 4 - Test property - invalid provider configured.
            tests.add(Arguments.of("Test-Profile-strongAlgorithms-InvalidProvider",
                    System.getProperty("test.src") + "/property-java.security",
                    "NoSuchProviderException: Provider '.*' not available"));
            // 5 - Test property - invalid algorithm.
            tests.add(Arguments.of("Test-Profile-strongAlgorithms-InvalidAlgorithm",
                    System.getProperty("test.src") + "/property-java.security",
                    "NoSuchAlgorithmException: Algorithm '.*' not available in provider '.*'"));
            // 6 - Test property - set invalid provider.
